...
} from '../configuration-azure-cognitive-sidebar/configuration-azure-cognitive-sidebar.component';
import {DeviceService} from '../../states/device.service';
import {
  ConfigurationDeviceSidebarComponent
} from '../configuration-device-sidebar/configuration-device-sidebar.component';
...
export class ConfigurationSidebarComponent implements ModalInstance<void> {
  ...
  constructor(private chanDaLiar: ChanDaLiarService,
